...
###it will either (i) become a palindrome in less than fifty iterations, or, (ii) no 
###one, with all the computing power that exists, has managed so far to map it to a 
###palindrome. In fact, 10677 is the first number to be shown to require over fifty 
###iterations before producing a palindrome: 4668731596684224866951378664 (53 iterations, 
###28-digits).
